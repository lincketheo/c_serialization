...
int bits_data_push(bits_data* data, const uint64_t _elem, const size_t _nbits)
{
...
uint64_t bits_data_get(const bits_data* data, const size_t _start, const size_t _nbits)
{
  assert(_nbits <= 64);
  uint64_t ret = 0;
